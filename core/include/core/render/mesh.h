...
#define MESH_INIT_FAIL_BAD_GLTF_FILE_PATH      1
#define MESH_INIT_FAIL_BAD_GLTF                2
#define MESH_INIT_FAIL_INVALID_INDEX_DATA_TYPE 3
...
class Mesh : public Asset {
  public:
    ...
    void loadModel(
        uint32_t vertexCount, const h_core::render::Vertex* vertexBuffer,
