...
#define HYLOG_VERBOSE(fmt, ...)  ::SDL_LogVerbose(SDL_LOG_CATEGORY_APPLICATION, fmt, ##__VA_ARGS__)
...
#define HYLOG_CRITICAL(fmt, ...) ::SDL_LogCritical(SDL_LOG_CATEGORY_APPLICATION, fmt, ##__VA_ARGS__)