...
uint32_t h_core::RuntimeSystems::init(h_core::Engine* engine) {
...
void h_core::RuntimeSystems::updateSystemReferences(h_core::System* system, h_core::Scene* scene, h_core::ActorId id) {
    system->actorId = id;
